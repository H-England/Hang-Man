  ...
  return (
    <div className= "helpbox">
            <div className='helpcont'>
                <h3>Hang-man How to Play:</h3>
                <ul>
                    <li>Step 1: Press The Start Button</li>
                    <li>Step 2: A Random word will be chosen to guees. Blank spaces will appear indicating how many letters there are in the word.</li>
